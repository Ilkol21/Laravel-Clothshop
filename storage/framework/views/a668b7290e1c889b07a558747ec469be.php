...
<style>
                            ...
                            <div class="accordion-body px-0 pb-0 pt-3">
                                <ul class="list list-inline mb-0">
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-item">
                                            <span class="menu-link py-1"> <input type="checkbox" name="categories" value="<?php echo e($category->id); ?>" class="chk-category"
                                             <?php if(in_array($category->id,explode(',',$f_categories))): ?> checked="checked" <?php endif; ?> /> <?php echo e($category->name); ?></span>
                                            <span class="text-right float-right"><?php echo e($category->products()->count()); ?></span>
                                        </li>
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <ul class="list list-inline mb-0 brand-list">
                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-item">
                                            <span class="menu-link py-1"> <input type="checkbox" name="brands" value="<?php echo e($brand->id); ?>" class="chk-brand"  <?php if(in_array($brand->id,explode(',',$f_brands))): ?> checked="checked" <?php endif; ?>  /> <?php echo e($brand->name); ?></span> <span class="text-right float-right"><?php echo e($brand->products()->count()); ?></span>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                                   data-slider-max="1000" data-slider-step="5" data-slider-value="[<?php echo e($min_price); ?>,<?php echo e($max_price); ?>]" data-currency="$" />
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        ...
                                        <h6 class="mb-0 animate animate_fade animate_btt animate_delay-5">Accessories are the best way to
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" id="sorting" name="sorting">
                            ...
                            <option value="3" <?php echo e($order==4 ? 'selected':''); ?>>Price, High to Low</option>
                        </select>
                ...
                <div class="products-grid row row-cols-2 row-cols-md-3" id="products-grid">
                                ...
                                <div class="pc__img-wrapper">
                                    <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img loading="lazy" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e($product->image); ?>" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <?php $__currentLoopData = explode(",",$product->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e(route('shop.product.details',["product_slug"=>$product->slug])); ?>">
                                                        <img loading="lazy" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e(trim($gimg)); ?>" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                                    </a>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                    ...
                    <span class="money price">
                        <?php if($product->sale_price): ?>
                            <s>$<?php echo e($product->regular_price); ?></s> $<?php echo e($product->sale_price); ?> <?php echo e(round(($product->regular_price - $product->sale_price)*100/$product->regular_price)); ?> % OFF
                        <?php else: ?>
    ...
    <form id="frmfilter" method="GET" action="<?php echo e(route('shop.index')); ?>">
        ...
        <input type="hidden" id="order" name="order" value="<?php echo e($order); ?>" />
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/shop.blade.php ENDPATH**/ ?>